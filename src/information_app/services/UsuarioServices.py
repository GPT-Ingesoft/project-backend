...
CAMPOS_BASE   = {'nombre', 'correo', 'contrasena', 'rol'}
CAMPOS_TECNICO = {'especialidad', 'contacto'}

LONGITUD_NOMBRE_MINIMA = 2
LONGITUD_CONTRASENA_MINIMA = 6
...
class UsuarioServices:
    ...
    def registrar_usuario(self, datos: dict) -> dict:
        ...
        if len(contrasena) < LONGITUD_CONTRASENA_MINIMA:
        ...
        usuario = self.usuario_repository.crear_usuario(nombre=nombre, correo=correo, contrasena_hash=contrasena_hash, rol=rol)
